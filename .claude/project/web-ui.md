...
- **Discover place (P5)** — `docs/js/v2/workbench/discover.js`. A rail *place*
  ...
  The Cues/Library tab bar is **retired**: `#tab-group` (the buttons) is CSS-hidden and Library
  is the `#wb-library-place` rail place (`docs/js/v2/workbench/library.js`); `#tab-nav` stays
