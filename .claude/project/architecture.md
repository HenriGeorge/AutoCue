...
tests/
  ...
  e2e/                       — Playwright smoke harness for the `autocue-qa` agent.
                               ...
                               header before any other spec runs (the `0-` prefix forces it ahead
                               of the long-running per-control-sweep in alphabetical order). Specs:
                               0-safety, selectors-exist,
