...
- `tests/e2e/0-safety.spec.ts` runs **first** (the `0-` filename prefix forces alphabetical-first discovery; see issue #119). It calls `/api/status` with the `X-AutoCue-Diagnostic: 1` header and asserts:
